...
namespace BAI_2._5_NULLABLE_TYPED
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int? temp2;                 // Hoặc Nullable<int> bienkieuint;

            temp2 = null;               // có thể gán null cho biến
            temp2 = 10;                 // có thể gán giá trị cho biến

            if (temp2 != null)
            {
                int val = temp2.Value;  // đọc giá trị trong biến nullable
            }
            ...
            if (temp4.HasValue)// kiểm tra giá tị trước khi dùng bằng HasValue
            {
                Console.WriteLine(temp4.Value);
            }
            else
            {
            ...
            //Dùng phương thức GetValueOrDefault() để lấy giá mặc định của kiểu dữ liệu
            Console.WriteLine(temp3.GetValueOrDefault());//Lấy giá trị mặc định cho temp là 0 với kieeurn int

            // Dùng toán tử ?? thực hiện gán Nullable Type cho Non-Nullable Type
            int? temp6 = null;
            int temp7 = temp6 ?? 0;//temp7 = temp6 nếu temp 6 khác null, temp7 = 0 nếu x = null
